...
//
// Form XObject descent: the page draws its text via a Form XObject; box ONLY the middle word "BBBB" of one
// text run "AAAA BBBB CCCC" (drawn through a Form XObject via Do) and
...
try {
  await page.goto('http://127.0.0.1:8163/?src=%2Fxobjtext.pdf', { waitUntil: 'networkidle', timeout: 60000 });
  ...
  assert(/AAAA/.test(text), 'the prefix "AAAA" survives (Form XObject descended, page not flattened)');
