CasualEditorIframe from @casualoffice/docs. Use via `window.CasualOfficeDocs.CasualEditorIframe` (bundle loaded from the root `_ds_bundle.js`).

## Props

```ts
interface CasualEditorIframeProps {
