...
/**
 * EditorToolbar — from @casualoffice/docs@1.1.7.
 */
...
export declare const EditorToolbar: React.ComponentType<EditorToolbarProps> & {
  TitleBar: React.ComponentType<any>;
  Logo: React.ComponentType<any>;
  DocumentName: React.ComponentType<any>;
  MenuBar: React.ComponentType<any>;
  TitleBarRight: React.ComponentType<any>;
  FormattingBar: React.ComponentType<any>;
};
