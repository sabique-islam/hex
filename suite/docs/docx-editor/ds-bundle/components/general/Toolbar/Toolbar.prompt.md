Toolbar from @casualoffice/docs. Use via `window.CasualOfficeDocs.Toolbar` (bundle loaded from the root `_ds_bundle.js`).
...
interface ToolbarProps {
  ...
  tableContext?: { isInTable: boolean; rowCount?: number; columnCount?: number; canSplitCell?: boolean; hasMultiCellSelection?: boolean; cellBorderColor?: ColorValue; cellBackgroundColor?: string; };
...
`ToolbarButton`, `ToolbarGroup`, `ToolbarSeparator`
